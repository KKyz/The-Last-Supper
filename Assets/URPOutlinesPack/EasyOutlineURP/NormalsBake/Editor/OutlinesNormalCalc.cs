...
public class BakeMeshNormalsToUV : EditorWindow
{
    ...
    private string DefaultPath = "Assets/EasyOutlineURP/NormalsBake/";
    ...
    {
        EditorWindow.GetWindow(typeof(BakeMeshNormalsToUV));
    }
