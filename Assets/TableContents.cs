...
public class TableContents : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
{
    #region Server
    ...
    protected override DiscoveryResponse ProcessRequest(DiscoveryRequest request, IPEndPoint endpoint)
    {
        ...
        res.hostName = PlayerPrefs.GetString("PlayerName");
        res.playerCount = GameManager.singleton.numPlayers;
